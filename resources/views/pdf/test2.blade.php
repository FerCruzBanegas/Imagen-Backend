...
<body>
  <div class="new-page">
    ...
    <div id="container">
      <div id="left">CÓDIGO: <span style="display:inline-block; float: right;">125-SCZ</span></div>
        <div id="right">
        ...
        <div id="center">ESPACIOS DISPONIBLES "SANTA CRUZ DE LA SIERRA"</div>
      </div>
      ...
      <div style="width: 100%;">
        <table class="styled-table">
          ...
          <tbody>
            <tr>
              <td colspan="2"><strong>Ciudad: </strong>Santa Cruz</td>
              <td colspan="2"><strong>Zona: </strong>La Ramada</td>
            </tr>
            <tr>
              <td colspan="5"><strong>Ubicación: </strong>Isabela Catolica</td>
            </tr>
            <tr>
              <td colspan="2"><strong>Dimensión: </strong>10 x 4</td>
              <td colspan="2"><strong>Costo: </strong>15000 Bs.</td>
            </tr>
            <tr>
              <td colspan="2"><strong>Iluminación: </strong>SI</td>
              <td><strong>Tipo: </strong>Unipolar</td>
            </tr>
          </tbody>
        </table>
      </div>
